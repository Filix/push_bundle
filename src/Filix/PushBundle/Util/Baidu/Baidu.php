...
use Filix\PushBundle\Util\SdkInterface;
use Filix\PushBundle\Util\Baidu\RequestCore;
use Filix\PushBundle\Util\Baidu\ChannelException;
use Filix\PushBundle\Util\Baidu\BaeBase;
use Filix\PushBundle\Util\Baidu\ResponseCore;
/**
 * 百度云消息通道服务 PHP SDK
 * 
 ...
 * @version 1.0.0.0
 */
class Baidu extends BaeBase implements SdkInterface
{
    /**
     * 可选参数的KEY
     * 
    ...
    public function init(array $parameters)
    {
        ...
        $this->setSecretKey($parameters['secret_key']);
    }
